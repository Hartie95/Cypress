...
public partial class MessageHandler
{
	...
	private sealed class HeartbeatState
	{
		...
		public HashSet<string> PlayerNames = new();
		...
		try
		{
			...
			switch (type)
			{
				...
				case "getPlaylists":
					...
					break;
				case "savePlaylist":
					OnSavePlaylist((string?)msg["name"] ?? "", (string?)msg["content"] ?? "");
					break;
				case "loadPlaylist":
					OnLoadPlaylist((string?)msg["name"] ?? "");
					break;
				case "deletePlaylist":
					OnDeletePlaylist((string?)msg["name"] ?? "");
					break;
				case "getRelayLease":
					OnGetRelayLease(msg);
					break;
				...
				case "modBanServer":
					OnModBanServer(msg);
					break;
				case "modBanServerByKey":
					OnModBanServerByKey(msg);
					break;
				case "modUnbanServer":
				...
				case "registerIdentity":
					OnRegisterIdentity(msg);
					break;
				case "rebindIdentity":
					OnRebindIdentity(msg);
					break;
				case "setNickname":
					OnSetNickname(msg);
					break;
